  ...
  return (
    <div className="page-transition flex-1 flex items-center justify-center px-6 py-32">
      <div className="text-center max-w-md">
        ...
        <h1 className="font-display text-4xl sm:text-5xl font-semibold text-[#111111] dark:text-white mb-4 leading-tight">
          Esta página no existe
        </h1>
        <p className="text-[#787774] dark:text-slate-400 mb-8 leading-relaxed">
